...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/12/28 15:14:47 by hcanon            #+#    #+#             */
/*   Updated: 2020/03/04 20:02:28 by hcanon           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
bool Number::operator==(Number const &b) const
{
	return (this->n == b.n);
}
...
bool Number::operator==(int const &n) const
{
	return (this->n == n);
}
