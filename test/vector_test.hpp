...
/*   Updated: 2020/03/05 16:42:59 by hcanon           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void test_Vector(void)
{
	std::cout << "\n---basic\n\n";
	{
		...
		std::cout << "reverse:\n";
		typename ft::ReverseIterator<typename VectorType::Itvector> it = vec.rbegin();
		typename ft::ReverseIterator<typename VectorType::Itvector> ite = vec.rend();
		while (it != ite)
		{
			std::cout << *it++;
			if (it == ite)
	...
	std::cout << "\n---push_back\n\n";
	{
		...
		typename ft::ReverseIterator<typename VectorType::Itvector> rit = vec.rbegin();
		typename ft::ReverseIterator<typename VectorType::Itvector> rite = vec.rend();
		int i = 1;
		std::cout << "(reverse) [5, 42, 3]:" << '\n';
		while (rit != rite)
			std::cout << i++ << " -> " << *rit++ << '\n';

		typename VectorType::Itvector it;
		typename VectorType::Itvector ite;
	...
	std::cout << "\n---erase\n\n";
	{
		...
		typename VectorType::Itvector it = vec.erase(--vec.end());
